  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
        ...
        <div class="sidebar-brand-text mx-3">SPK Parfum</div>
      </a>
      ...
      <li class="nav-item {{ Request::is('parfumes*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('parfumes') }}">
          <i class="fas fa-fw fa-bong"></i>
          <span>Data Parfum</span></a>
      </li>
      <li class="nav-item {{ Request::is('criterias*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('criterias') }}">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Iwan Syarief 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
